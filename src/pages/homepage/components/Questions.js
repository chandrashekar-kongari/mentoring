...
export default function Questions() {
    ...
    const [ques,SetQues]=React.useState([
        ...
        },
        {
            ...
            answer:"We will not share your data. TechPACT exists to serve diverse technologists, and the profile information you provide is anonymously aggregated to capture our impact for reporting purposes. Refer to our {privacy policy} for more details."
        },{
          id:4,
...
Frequently Asked Questions
        ...
        {ques.map((que)=>{
          ...
          <Typography variant='h8'>please contact us at <span style={{borderBottom:'2px solid #1226AA'}}>mentoring@techpact.org</span></Typography>
          </Stack>
